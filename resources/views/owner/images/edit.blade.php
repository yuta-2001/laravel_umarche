                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="post" action="{{ route('owner.images.update', ['image' => $image->id]) }}">
                        ...
                        <div class="-m-2">
                            ...
                            <div class="p-2 w-full mt-4 flex justify-around">
                                <button type="button" onclick="location.href='{{ route('owner.images.index') }}'" accept="image/png,image/jpeg,image/jpg" class=" bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
                    ...
                    <form id="delete_{{ $image->id }}" method="post" action="{{ route('owner.images.destroy', ['image' => $image->id]) }}">
                      ...
                      <div class="p-2 w-full mt-16 flex justify-around">
                        <a href="#" data-id="{{ $image->id }}" type="button" onclick="deletePost(this)" class=" text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除する</a>
                      </div>
                    </form>
                </div>
            </div>

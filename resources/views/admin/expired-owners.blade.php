                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <form id="delete_{{ $owner->id }}" method="post" action="{{ route('admin.expired-owners.destroy', ['owner' => $owner->id]) }}">
                                    ...
                                    {{-- @method('delete') --}}
                                  <td class="px-4 py-3">
                                    <a href="#" data-id="{{ $owner->id }}" type="button" onclick="deletePost(this)" class=" text-white bg-red-400 border-0 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">完全に削除</a>
                                  </td>
                                  </form>
                                </tr>
                                @endforeach
